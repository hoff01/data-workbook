...
DEFAULT_MONTHLY_BULK_SOURCE = Path("cache/eia/PET.zip")
LEGACY_MONTHLY_BULK_SOURCE = Path("PET.zip")
MONTHLY_BULK_SOURCE = Path(os.environ.get("EIA_MONTHLY_BULK_SOURCE", "")) if os.environ.get("EIA_MONTHLY_BULK_SOURCE") else (
    DEFAULT_MONTHLY_BULK_SOURCE if DEFAULT_MONTHLY_BULK_SOURCE.exists() or not LEGACY_MONTHLY_BULK_SOURCE.exists() else LEGACY_MONTHLY_BULK_SOURCE
)
